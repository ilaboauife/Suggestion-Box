                    ...
                    <img src="{{ asset('public/assets/img/logo.png')}}" alt="" class="navbar-brand-media-img navbar-brand-media-img-dark">
                        ...
                        <div id="site_header_navbar_collapse" class="collapse navbar-collapse">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="{{url('/')}}#page_intro_section" ><span class="navbar-nav-elem-wrap"><span class="widget-title primary-text-dark">Home</span></span></a></li>
                                <li><a href="{{url('/interest')}}"><span class="navbar-nav-elem-wrap"><span class="widget-title primary-text-dark">How it works</span></span></a></li>
                                <li><a href="" ><span class="navbar-nav-elem-wrap"><span class="widget-title primary-text-dark">Contact</span></span></a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
